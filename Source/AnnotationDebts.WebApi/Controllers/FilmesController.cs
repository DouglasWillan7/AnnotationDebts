...
using AnnotationDebts.Domain.Services;
...
namespace AnnotationDebts.WebApi.Controllers
{
    [ApiVersion("1.0")]
    public class FilmesController : ApiController
    {
        ...
        {
            this.filmesService = filmesService ?? throw new ArgumentNullException(nameof(filmesService));
        }
